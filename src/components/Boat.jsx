...
export default function Boat() {
    ...
    return (
      ...
      <div>
         <Helmet>
                    <title>Get Boat Coupons  Promo Codes Coupon Code </title>
                    <meta name="description" content="Get Boat Coupons  Promo Codes Coupon Code Today apply these code and enjoy your shoping at couponcodeministry" />
                </Helmet>  
        <NavbarMenu />
        ...
        <BrandInfo
          imageUrl={boat}
          name="Boat"
          description="boat is a multinational technology company focused on e-commerce, cloud computing, and artificial intelligence. Founded in 1994 by Jeff Bezos, boat is one of the largest online marketplaces globally, providing a wide range of products and services."
        />
  
        {Object.keys(groupedData).length > 0 && groupedData['Boat'] ? (
          <div>
            <Container>
            <Heading heading="Best Deals of Boat" />
              <ul className="campaign-List">
                {groupedData['Boat'].map((item, i) => {
                  return (
                    <li key={i}>
